...
const Sidebar = ({ isOpen, closeSidebar }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      color: 'from-blue-500 to-blue-600',
      subItems: [
        { title: 'الأقسام', icon: <FaBuilding />, path: '/hr/departments' },
        { title: 'المناصب', icon: <FaUserPlus />, path: '/hr/positions' },
        { title: 'الموظفين', icon: <FaUsers />, path: '/hr/employees' },
        { title: 'الحضور والانصراف', icon: <FaClock />, path: '/hr/attendance' },
        { title: 'طلبات الإجازات', icon: <FaCalendarAlt />, path: '/hr/leave-requests' },
        { title: 'تقييمات الأداء', icon: <FaChartLine />, path: '/hr/performance' },
      ]
    },
    {
      id: 'accounting',
      ...
      subItems: [
        { title: 'دليل الحسابات', icon: <FaSitemap />, path: '/accounting/chart-of-accounts' },
        { title: 'الدفتر اليومية', icon: <FaClipboardList />, path: '/accounting/journal-entries' },
        { title: 'دفتر الأستاذ', icon: <FaBook />, path: '/accounting/ledger' },
        { title: 'الميزانية العمومية', icon: <FaBalanceScale />, path: '/accounting/balance-sheet' },
        { title: 'قائمة الدخل', icon: <FaChartLine />, path: '/accounting/income-statement' },
        { title: 'الحسابات البنكية', icon: <FaUniversity />, path: '/accounting/bank-accounts' },
        { title: 'المدفوعات والمقبوضات', icon: <FaMoneyBillWave />, path: '/accounting/payments' },
      ]
    },
    {
      id: 'reports',
    ...
    },
    {
      ...
      subItems: [
        { title: 'لوحة التحكم', icon: <FaChartBar />, path: '/budgeting' },
        { title: 'إدارة الميزانيات', icon: <FaBuilding />, path: '/budgeting/budgets' },
        { title: 'التنبؤات المالية', icon: <FaChartLine />, path: '/budgeting/forecasts' },
        { title: 'خطط الإنتاج', icon: <FaCogs />, path: '/budgeting/production-plans' },
        { title: 'خطط المشتريات', icon: <FaList />, path: '/budgeting/purchase-plans' },
        { title: 'التقارير والتحليلات', icon: <FaClipboardList />, path: '/budgeting/reports' },
      ]
    },
    {
      id: 'crm',
